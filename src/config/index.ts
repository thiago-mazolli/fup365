...
export const taskPedido = '0 0 22 * * *'; // Todos os dias às 22h
// export const taskPedido = '0 */10 * * * *'; // // 10 em 10 minutos
export const taskPedidoCanc = '0 */10 * * * *'; // 10 em 10 minutos
export const taskRecebimento = '0 */10 * * * *'; // 10 em 10 minutos
